...
<div class="modal fade text-left" id="updateAvatar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.users.avatar', $user->uid) }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            @enderror
                            <p><small class="text-primary"> {{__('locale.user.profile_image_size')}} </small></p>
                        </div>
                    </div>
