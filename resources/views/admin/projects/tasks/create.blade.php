...
@section('title', __('locale.task.create_new_task'))
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> {{ __('locale.task.create_new_task') }} </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical"
                                action="{{ route('admin.tasks.store', ['project' => $project->uid]) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <input type="text" id="estimate" class="form-control flatpickr-time text-start"
                                            name="estimate" placeholder="Y-m-d HH:MM" />
                                        @error('estimate')
                                            <p><small class="text-danger">{{ $message }}</small></p>
                                        @enderror
                                    </div>
