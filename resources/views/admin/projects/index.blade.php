...
@section('title', __('locale.menu.Projects'))
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full) {
                            ...
                            return (
                                '<div class="btn-group">' +
                                '<a href="' + full['view'] + '" class="btn btn-success waves-light waves-effect fw-bold" data-bs-toggle="tooltip" data-placement="top">' +
                                '{{ __('locale.buttons.view_project') }}' + ' </a></div>'
