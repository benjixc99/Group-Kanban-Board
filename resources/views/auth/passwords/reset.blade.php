        ...
        <div class="auth-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                    <img src="{{ asset('images/pages/reset-password.svg') }}" class="img-fluid" alt="Register V2" />
                </div>
            </div>
            <!-- /Left Text-->
                    ...
                    <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-1">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                name="email" placeholder="{{ __('locale.labels.email') }}"
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input id="password" type="password"
                                    ...
                                    name="password" placeholder="{{ __('locale.labels.password') }}" required
                                    autocomplete="new-password" autofocus tabindex="1">
                        ...
                        <div class="mb-1">
                            <div class="d-flex justify-content-between">
                                <label class="form-label"
                                    for="password-confirm">{{ __('locale.labels.password_confirmation') }}</label>
                            </div>
                            <div class="input-group input-group-merge form-password-toggle">
                                <input id="password-confirm" type="password" class="form-control form-control-merge"
                                    name="password_confirmation"
                                    placeholder="{{ __('locale.labels.password_confirmation') }}" required
                        ...
                        <button type="submit" class="btn btn-primary w-100"
                            tabindex="3">{{ __('locale.buttons.reset') }}</button>
                    </form>
