...
class Tool
{
    ...
    /**
     * Format hours for humans
     * @param int $hours
     * @return string
     */
    public static function formatHoursForHumans($hours)
    {
        $timeToComplete = Carbon::now()->addHours($hours);
        $diff = $timeToComplete->diffForHumans(null, true, false, 2);
        return $diff;
    }
    /**
     * Get all time zone.
